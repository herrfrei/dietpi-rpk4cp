...
[ -l brcmfmac43455-sdio.radxa,rock-4c-plus.bin ] && rm -f brcmfmac43455-sdio.radxa,rock-4c-plus.bin
ln -s ../cypress/cyfmac43455-sdio.bin brcmfmac43455-sdio.radxa,rock-4c-plus.bin

[ -l brcmfmac43455-sdio.radxa,rock-4c-plus.clm_blob ] && rm -f brcmfmac43455-sdio.radxa,rock-4c-plus.clm_blob
